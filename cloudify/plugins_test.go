...
const pluginsDeleteResponce = `{
	"distribution_release": "core",
	"supported_py_versions": ["py27"],
	"uploaded_at": "2018-03-27T18:15:14.528Z",
	"archive_name": "cloudify_vsphere_plugin-2.5.0-py27-none-linux_x86_64-centos-Core.wgn",
	...
	"created_by": "admin",
	"distribution": "centos",
	"package_source": "../cloudify-vsphere-plugin/",
	"private_resource": false,
	"file_server_path": "",
	"resource_availability": "tenant",
	"visibility": "tenant",
	...
	"wheels": [
		...
		"enum34-1.1.6-py2-none-any.whl",
		"cloudify_plugins_common-3.4.2-py2-none-any.whl",
		"pyvmomi-6.5.0.2017.5-py2.py3-none-any.whl",
		"PyYAML-3.11-cp27-cp27mu-linux_x86_64.whl",
		"cloudify_vsphere_plugin-2.5.0-py2-none-any.whl",
		"cloudify_rest_client-3.4.2-py2-none-any.whl",
		"pika-0.9.14-py2-none-any.whl",
		"networkx-1.8.1-py2-none-any.whl",
		"proxy_tools-0.1.0-py2-none-any.whl",
		"bottle-0.12.7-py2-none-any.whl",
		"Jinja2-2.7.2-py2-none-any.whl",
		"lxml-4.2.1-cp27-cp27mu-linux_x86_64.whl",
		"MarkupSafe-1.0-cp27-cp27mu-linux_x86_64.whl",
		"cryptography-2.2.1-cp27-cp27mu-linux_x86_64.whl",
		"cffi-1.11.5-cp27-cp27mu-linux_x86_64.whl",
		"ipaddress-1.0.19-py2-none-any.whl",
		"pycparser-2.18-py2.py3-none-any.whl"
	],
	"id": "0227b9c2-6180-4fad-b448-02da74f33155",
	"yaml_url_path": ""
}`

// TestDeletePlugins - check DeletePlugins
func TestDeletePlugins(t *testing.T) {
	var conn tests.FakeClient
	var forceParams CallWithForce
	conn.DeleteResponse = []byte(pluginsDeleteResponce)
	conn.DeleteError = nil
	cl := ClientFromConnection(&conn)
	plugin, err := cl.DeletePlugins("0227b9c2-6180-4fad-b448-02da74f33155", forceParams)
	if err != nil {
		t.Error("Recheck error reporting")
	}
	tests.AssertEqual(t, plugin.ID, "0227b9c2-6180-4fad-b448-02da74f33155",
		"Recheck unmarshal for 'id' field in plugin '%s'", plugin.ID)
}
